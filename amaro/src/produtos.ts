export const produtos = [
    {
      ...
      {
        "id" : 8363 ,
        "nome" : " VESTIDO CURTO MANGA LONGA LUREX " ,
        "tags" : [ " colorido " , " metal " , " delicado " , " estampas " , " passeio " ]
      },
      {
        "id" : 8360 ,
        "nome" : " VESTIDO FEMININO CANELADO " ,
      ...
      {
        "id" : 8314 ,
        "nome" : " VESTIDO PLISSADO ACINTURADO " ,
      ...
      {
        "id" : 8310 ,
        "nome" : " VESTIDO CURTO PONTO ROMA MANGA " ,
      ...
      {
        "id" : 8109 ,
        "nome" : " VESTIDO BABADOS HORIZONTAIS " ,
        "tags" : [ " moderno " , " boho " , " festa " , " descolado " , " colorido " ]
      },
      {
        "id" : 8104 ,
        "name" : " VESTIDO BABADO GOLA TURTLE " ,
